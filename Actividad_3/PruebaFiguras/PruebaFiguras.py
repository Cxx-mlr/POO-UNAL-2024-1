...
class PruebaFiguras(App[None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="main-panel"):
            ...
            yield InputWithLabel("[blue]Radio:[/]", label_width=22, type="number", id="circle-radius", validators=[
            ...
            yield InputWithLabel("[yellow]Base:[/]", label_width=22, type="number", id="rectangle-base", validators=[
                Length(minimum=1, failure_description="Este campo es obligatorio."),
                Number(failure_description="El número ingresado es incorrecto."),
                Number(minimum=0, failure_description="Ingrese un número real no negativo.")
            ])
            yield InputWithLabel("[yellow]Altura:[/]", label_width=22, type="number", id="rectangle-height", validators=[
                Length(minimum=1, failure_description="Este campo es obligatorio."),
                Number(failure_description="El número ingresado es incorrecto."),
                Number(minimum=0, failure_description="Ingrese un número real no negativo.")
            ])
            ...
            yield InputWithLabel("[green]Lado:[/]", label_width=22, type="number", id="square-side", validators=[
                Length(minimum=1, failure_description="Este campo es obligatorio."),
                Number(failure_description="El número ingresado es incorrecto."),
                Number(minimum=0, failure_description="Ingrese un número real no negativo.")
            ])
            ...
            yield InputWithLabel("[red]Base:[/]", label_width=22, type="number", id="triangle-base", validators=[
                Length(minimum=1, failure_description="Este campo es obligatorio."),
                Number(failure_description="El número ingresado es incorrecto."),
                Number(minimum=0, failure_description="Ingrese un número real no negativo.")
            ])
            yield InputWithLabel("[red]Altura:[/]", label_width=22, type="number", id="triangle-height", validators=[
                Length(minimum=1, failure_description="Este campo es obligatorio."),
                Number(failure_description="El número ingresado es incorrecto."),
                Number(minimum=0, failure_description="Ingrese un número real no negativo.")
            ])
